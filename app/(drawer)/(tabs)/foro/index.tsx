  ...
  const renderPost = ({ item }: { item: Post }) => (
    <View className="bg-white p-4 rounded-3xl mb-4 shadow-sm border border-gray-100 mx-2">
      <View className="flex-row items-center mb-3">
        <Image
          source={{ uri: item.profiles?.avatar_url || 'https://mqloxtnhyefawnoiwpeu.supabase.co/storage/v1/object/public/multimedia/general/user.png' }}
    ...
    // se puede meter este text en un view
  ...
  return (
    <SafeAreaView className="flex-1 bg-secondary-200">
      <View className="px-4 py-2">
        <Text className="text-secondary text-3xl font-work-black mb-2">Foro</Text>
      ...
      />
      <TouchableOpacity
        className="absolute bottom-6 right-6 bg-blueone w-14 h-14 rounded-full items-center justify-center shadow-lg"
        ...
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-white rounded-t-3xl p-6 h-[60%] shadow-2xl">
            <View className="flex-row justify-between items-center mb-6">
              <Text className="text-xl font-work-bold text-secondary">Nueva Publicación</Text>
