...
export default function TraductorScreen() {
  ...
  useEffect(() => {
    ...
    Voice.onSpeechError = (e) => {
      ...
      Alert.alert(
        "No te entendí",
        "Intenta hablar más fuerte o escribe la palabra.",
      );
    };
  ...
  return (
    <View className="flex-1 bg-secondary-200 p-6">
      <Text className="text-center font-work-black text-2xl text-primary mb-2 mt-4">
        Traductor LSM
      </Text>
      <Text className="text-center text-gray-500 mb-8">
        Presiona y habla para traducir
      </Text>
        ...
        <View className="bg-white rounded-3xl overflow-hidden shadow-2xl items-center border border-gray-100 flex-1 mb-6">
          ...
          <View className="p-6 w-full bg-white border-t border-gray-100 items-center">
            ...
            <Text
              ...
              className="text-4xl font-work-black text-primary  capitalize"
            >
              {resultado.word}
            </Text>
          </View>
